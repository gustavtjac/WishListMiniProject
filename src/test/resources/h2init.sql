...
INSERT INTO WISHLIST (WISHLIST_ID, WISHLIST_USER_ID, WISHLIST_NAME) VALUES
                                                                        (RANDOM_UUID(), 1, 'Christmas Gifts'),
...
SELECT RANDOM_UUID(), WISHLIST_ID, 'Wireless Headphones', 'Noise-cancelling bluetooth headphones',
       'https://images.unsplash.com/photo-1505740420928-5e0f0bd5e321', 199.99, 'https://store.com/headphones'
FROM WISHLIST WHERE WISHLIST_NAME = 'Christmas Gifts';

INSERT INTO WISH (WISH_ID, WISH_WISHLIST_ID, WISH_NAME, WISH_DESC, WISH_IMGURL, WISH_PRICE, WISH_URL)
SELECT RANDOM_UUID(), WISHLIST_ID, 'Smartwatch', 'Latest fitness tracking smartwatch',
       'https://images.unsplash.com/photo-1579586337278-3befd40fd17a', 249.50, 'https://store.com/smartwatch'
FROM WISHLIST WHERE WISHLIST_NAME = 'Christmas Gifts';

INSERT INTO WISH (WISH_ID, WISH_WISHLIST_ID, WISH_NAME, WISH_DESC, WISH_IMGURL, WISH_PRICE, WISH_URL)
SELECT RANDOM_UUID(), WISHLIST_ID, 'Laptop', 'High-performance ultrabook',
       'https://images.unsplash.com/photo-1498050108023-c5249f4df085', 1299.00, 'https://store.com/laptop'
FROM WISHLIST WHERE WISHLIST_NAME = 'Tech Wishlist';

INSERT INTO WISH (WISH_ID, WISH_WISHLIST_ID, WISH_NAME, WISH_DESC, WISH_IMGURL, WISH_PRICE, WISH_URL)
SELECT RANDOM_UUID(), WISHLIST_ID, 'Travel Backpack', 'Waterproof hiking backpack',
       'https://images.unsplash.com/photo-1491637639971-8a8054e9a52e', 129.99, 'https://store.com/backpack'
FROM WISHLIST WHERE WISHLIST_NAME = 'Travel Gear';
